...
class Sql():
  ...
  def startSQL(self,cfg,modul):
    ...
    self.form.clear()
    self.costume.clear()
    self.weather_boosted_condition.clear()
    ...
    if modul == "0er":
      ...
      try:
        while i < len(all):
          ...
          self.weather_boosted_condition.append(all[i][16])
          i +=1
